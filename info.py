...
PICS = (environ.get('PICS', 'https://telegra.ph/file/58fef5cb458d5b29b0186.jpg https://telegra.ph/file/f0aa4f433132769f8970c.jpg https://telegra.ph/file/f515fbc2084592eca60a5.jpg https://telegra.ph/file/20dbdcffaa89bd3d09a74.jpg https://graph.org/file/56b5deb73f3b132e2bb73.jpg https://graph.org/file/5303692652d91d52180c2.jpg https://graph.org/file/425b6f46efc7c6d64105f.jpg https://graph.org/file/876867e761c6c7a29855b.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7413682152').split()] # Replace with the actual admin ID(s) to add
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/MktVL566/20250904-173553.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'satyajeetfino@finobank')    # Owner UPI ID for payments
...
DATABASE_NAME = environ.get('DATABASE_NAME', "ProBotz") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'CollectionProBotz') # Collection name (default: dreamcinezone_files)
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/ProBotUpdate")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/ProBotUpdate")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/ProBotUpdate")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "1a2887e5dc4c4e8134a7b0afd82e8f2cfc0ee2d4") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "shrinkme.top") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "1a2887e5dc4c4e8134a7b0afd82e8f2cfc0ee2d4")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "shrinkme.top") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "1a2887e5dc4c4e8134a7b0afd82e8f2cfc0ee2d4")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "shrinkme.top") # Shortener website for third website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MoviesSearchPro') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Satyajeetkumarofficial') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/ProBotUpdate') # Update channel link for the bot
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'Media_search'))
MULTI_CLIENT = False
name = str(environ.get('name', 'PROBOTZ'))
